...
var PieChart = (function (_BaseChart) {
    ...
    _createClass(PieChart, [{
        ...
        value: function arcTween(a) {
            ...
            var interpolated = _d32["default"].interpolate(this.originalAngles, a);
        ...
        value: function create(data) {
            ...
            this.arc = _d32["default"].svg.arc().outerRadius(radius - 10).innerRadius(this.props.innerRadius);

            this.pie = _d32["default"].layout.pie().sort(null).value(function (d) {
                return d.value;
            });

            this.svg = _d32["default"].select(this.el).append("svg").attr("width", width).attr("height", svgHeight).append("g").attr("transform", "translate(" + halfWidth + ", " + halfHeight + ")");

            this.path = this.svg.selectAll("path").data(this.pie(_d32["default"].entries(data))).enter().append("path");
        ...
        value: function update(data) {
            ...
            this.path.data(this.pie(_d32["default"].entries(data))).transition().duration(this.transitionDuration).attrTween("d", this.arcTween.bind(this));

            this.path.data(this.pie(_d32["default"].entries(data))).enter().append("path").attr("fill", function (d, i) {

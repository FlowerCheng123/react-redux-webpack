...
var BarChart = (function (_BaseChart) {
    ...
    _createClass(BarChart, [{
        ...
        value: function getScaleX() {
            return _d32["default"].scale.ordinal().rangeRoundBands([0, this.props.width], 0.1);
        }
    }, {
        key: "getScaleY",
        value: function getScaleY() {
            return _d32["default"].scale.linear().range([this.props.height, 0]);
        }
    }, {
        key: "createAxisX",
        value: function createAxisX(x) {
            return _d32["default"].svg.axis().scale(x).orient("bottom");
        }
    }, {
        key: "createAxisY",
        value: function createAxisY(y) {
            return _d32["default"].svg.axis().scale(y).orient("left");
        }
    }, {
        key: "onMouseOver",
        ...
        value: function create(data) {
            ...
            this.svg = _d32["default"].select(this.el).append("svg").attr("width", width).attr("height", height).append("g").attr("transform", "translate(" + this.props.margin.left + ", " + this.props.margin.top + ")");

            this.x.domain(data.map(function (d) {
                return d.xValue;
            }));
            this.y.domain([0, _d32["default"].max(data, function (d) {
                return d.yValue;
            })]);
